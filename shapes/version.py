...
description = "shapes: a template for small scientific Python projects"
...
.. _README: https://github.com/uwescience/shapes/blob/master/README.md

License
=======
``shapes`` is licensed under the terms of the MIT license. See the file
